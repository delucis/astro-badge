...
import { type PageInfoForward, paginateGraphQL } from '@octokit/plugin-paginate-graphql';
import { type PaginatingEndpoints, paginateRest } from '@octokit/plugin-paginate-rest';
